...
const VendorProducts = () => {
  ...
  const addProduct = async (e) => {
    e.preventDefault();
    const url = BaseUrl() + "/product/selleradd";
                ...
                return (
                  <tr key={i} className="tracking-wider text-gray-900 ">
                    <td className=" py-3 w-12 md:text-base text-sm ">
                      <img
                        src={
                          "https://dtou.herokuapp.com/" +
                          e?.productPictures[0]?.img
                        }
                        alt=""
                    ...
                    <td className="px-4 py-3 md:text-base text-sm">
                      {e.instock === true ? "Available" : "Not Available"}
                    </td>
                    <td className="px-4 py-3  space-x-3 flex items-center">
                      <button
                        onClick={() => {
                          navigate(`/vendorViewProduct/${e._id}`);
                        }}
                        className="font-semibold tracking-widest border border-slate-400 px-3 py-1"
                      >
                        View
                      </button>
                      <button
